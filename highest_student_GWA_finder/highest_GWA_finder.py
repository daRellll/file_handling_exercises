    ...
    def file_data_loader (self):
         with open(self.file_name, "r") as student_GWA_file:
              for line in student_GWA_file:
                   ...
                   self.student_and_GWA_list.append([student_name, float(GWA)])

    def top_student_finder(self):
          top_student = min(self.student_and_GWA_list, key=lambda x: x[1])
